...
> [`onion/mybatis-plus`](https://github.com/xfoundries/jfoundry-expense-approval-demo/tree/onion/mybatis-plus) 分支。
...
|------|----------|--------------------|
| `hexagonal/mybatis-plus` | Hexagonal Architecture | 仓库默认分支上的当前实现；下文包结构和运行时说明均以此分支为准。 |
| [`onion/mybatis-plus`](https://github.com/xfoundries/jfoundry-expense-approval-demo/tree/onion/mybatis-plus) | Onion Simple Architecture | 单独维护的验证变体，拥有自己的 README 和架构语义。 |
