...
@Transactional
class ExpenseClaimQueryAdapterTest extends PostgreSqlIntegrationTest {
    ...
    void queryDerivesPaymentStateAndIncludesProjectedResult() {
        ...
        Map<String, ClaimSummary> summaries = queryPort.findOwned(
        ...
        ClaimDetail detail = queryPort.findDetail(ExpenseClaimId.of("claim-failed")).orElseThrow();
