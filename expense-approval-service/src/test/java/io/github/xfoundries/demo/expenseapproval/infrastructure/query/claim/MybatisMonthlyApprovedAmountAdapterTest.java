...
@Transactional
class MybatisMonthlyApprovedAmountAdapterTest extends PostgreSqlIntegrationTest {

    @Autowired JdbcTemplate jdbcTemplate;
    @Autowired MonthlyApprovedAmountPort port;
    ...
    void sumsOnlyApprovedClaimsForTheEmployeeInsideTheHalfOpenRange() {
        ...
        Money total = port.totalApproved(UserId.of("employee-1"), from, to);
