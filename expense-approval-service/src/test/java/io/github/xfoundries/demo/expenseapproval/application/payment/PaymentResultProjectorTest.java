...
import io.github.xfoundries.demo.expenseapproval.application.payment.PaymentStatusProjectionStore.PaymentStatusProjection;
...
class PaymentResultProjectorTest {
    ...
    private final PaymentStatusProjectionStore projectionStore = mock(PaymentStatusProjectionStore.class);
    ...
    void projectsPaidEventOnlyOnce() throws Exception {
        ...
        verify(projectionStore).upsert(projection.capture());
