...
import io.github.xfoundries.demo.expenseapproval.adapter.out.persistence.claim.ClaimActionData;
import io.github.xfoundries.demo.expenseapproval.adapter.out.persistence.claim.ClaimActionMapper;
import io.github.xfoundries.demo.expenseapproval.adapter.out.persistence.claim.ExpenseClaimData;
import io.github.xfoundries.demo.expenseapproval.adapter.out.persistence.claim.ExpenseClaimMapper;
import io.github.xfoundries.demo.expenseapproval.adapter.out.persistence.claim.ExpenseItemData;
import io.github.xfoundries.demo.expenseapproval.adapter.out.persistence.claim.ExpenseItemMapper;
...
@SecondaryAdapter
@Repository
public class MybatisExpenseClaimViewAdapter
    ...
    public MybatisExpenseClaimViewAdapter(
    ...
    public Optional<ClaimDetail> findDetail(ExpenseClaimId id) {
        return query(() -> {
            ...
            List<ItemView> items = itemMapper.selectByClaimId(id.value()).stream()
                    .map(MybatisExpenseClaimViewAdapter::toView)
                    .toList();
