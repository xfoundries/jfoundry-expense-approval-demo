...
public final class FinalApprovalCoordinator {
    ...
    private final MonthlyApprovedAmountPort monthlyApprovedAmountPort;
    private final MonthlyApprovalLimitPolicy limitPolicy;
    ...
    public FinalApprovalCoordinator(
            ...
            MonthlyApprovalLimitPolicy limitPolicy,
        ...
        this.monthlyApprovedAmountPort = Objects.requireNonNull(monthlyApprovedAmountPort);
    ...
    private void approveFinally(
            ExpenseClaimId claimId, Actor actor, UserId claimant, ApprovalStage stage) {
    ...
    private void completeFinalApproval(
        ...
        limitPolicy.ensureWithinLimit(
                monthlyApprovedAmountPort.totalApproved(expectedClaimant, from, to), claim.total());
        if (stage == ApprovalStage.MANAGER) {
    ...
    private static void requireRole(Actor actor, ActorRole role) {
        if (actor.role() != role) {
