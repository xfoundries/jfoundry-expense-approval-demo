...
public final class FinalApprovalCoordinator {
    ...
    private final ApprovedExpenseAmountPort approvedExpenseAmountPort;
    ...
    public FinalApprovalCoordinator(
        ...
        this.approvedExpenseAmountPort = Objects.requireNonNull(approvedExpenseAmountPort);
    ...
    private void completeFinalApproval(
        ...
        limitPolicy.ensureWithinLimit(
                approvedExpenseAmountPort.totalApproved(expectedClaimant, from, to), claim.total());
        if (stage == ApprovalStage.MANAGER) {
